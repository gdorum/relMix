...
This vignette gives an introduction to RelMix 1.3, the graphical user interface of the relMix package. We will present the main features of the GUI with two examples.
